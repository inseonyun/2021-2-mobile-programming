...
public class Task2_third extends AppCompatActivity {
    // 위젯 변수 선언
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task2_third);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task2_third.this, Task2_first.class);
