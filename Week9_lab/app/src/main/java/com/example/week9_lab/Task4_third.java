...
public class Task4_third extends AppCompatActivity {
    // 위젯 변수 선언
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task4_third);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task4_third.this, Task4_first.class);
