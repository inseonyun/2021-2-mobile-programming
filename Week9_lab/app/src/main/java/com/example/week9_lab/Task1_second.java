...
public class Task1_second extends AppCompatActivity {
    // 위젯 변수 선언
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task1_second);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task1_second.this, Task1_first.class);
