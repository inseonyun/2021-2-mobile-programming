...
public class Task4_fourth extends AppCompatActivity {
    // 위젯 변수 선언
    EditText et_rev;
    Chronometer chrono;
    Button btn_start, btn_end, btn_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task4_fourth);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // btn_back 이 눌리면 main으로 돌아감
                Intent intent = new Intent(Task4_fourth.this, Task4_first.class);
