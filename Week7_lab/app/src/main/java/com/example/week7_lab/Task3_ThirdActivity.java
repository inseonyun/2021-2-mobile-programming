...
public class Task3_ThirdActivity extends AppCompatActivity {
    // 위젯 변수 선언
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task3_third);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_ThirdActivity.this, Task3_FourthActivity.class);
