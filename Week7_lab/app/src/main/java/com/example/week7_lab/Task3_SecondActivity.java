...
public class Task3_SecondActivity extends AppCompatActivity {
    // 위젯 변수 선언
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task3_second);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_SecondActivity.this, Task3_FourthActivity.class);
