...
public class Task3_FourthActivity extends AppCompatActivity {
    // 위젯 변수 선언
    EditText et_rev;
    Chronometer chrono;
    Button btn_start, btn_end, btn_first, btn_second, btn_third;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task3_fourth);
        ...
        // btn_first 버튼을 누르면 first 액티비티로 이동
        btn_first.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_FourthActivity.this, Task3_FirstActivity.class);
                startActivity(intent);
            }
        });

        // btn_second 버튼을 누르면 second 액티비티로 이동
        btn_second.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_FourthActivity.this, Task3_SecondActivity.class);
                startActivity(intent);
            }
        });

        // btn_third 버튼을 누르면 third 액티비티로 이동
        btn_third.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_FourthActivity.this, Task3_ThirdActivity.class);
                startActivity(intent);
            }
        });
