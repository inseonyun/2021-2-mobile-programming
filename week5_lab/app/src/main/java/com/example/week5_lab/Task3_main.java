...
public class Task3_main extends AppCompatActivity {
    //각 위젯 변수 선언
    Button btn_ck1, btn_ck2, btn_radio, btn_car, btn_cal;
    CheckBox chk_me;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // btn_car가 눌렸을 때 Task3_car로 액티비티 이동
        btn_car.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_main.this, Task3_car.class);
                startActivity(intent);
            }
        });

        // btn_cal이 눌렸을 때 Tsk3_cal로 액티비티 이동
        btn_cal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Task3_main.this, Task3_cal.class);
                startActivity(intent);
            }
        });
    }
